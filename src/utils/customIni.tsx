...
const encode = (
  ...
  if (opt.platform == undefined) {
    if (typeof process !== "undefined") {
      opt.platform = process.platform;
    }
  }
...
const decode = (str: string, opt: DecodeOptions = {}): Record<string, any> => {
  opt.bracketedArray = opt.bracketedArray !== false;
...
/*
const isQuoted = (val: string): boolean => {
  return (
...
export { encode, decode, safe, unsafe };
